...
"""Main entry point for VideoVCP.

This module contains the code necessary to be able to launch VideoVCP
...
Example:
    ...
    launch video_vcp CNC by saying::

        $ video_vcp --ini=/path/to/config.ini [options ...]
...
def main(opts=None):
    ...
    if opts is None:
        ...
        opts = parse_opts(vcp_cmd='video_vcp',
                          vcp_name='VideoVCP',
